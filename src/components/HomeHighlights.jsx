  ...
  return (
    <div className="w-[37%]">
      <div className="flex w-full items-center justify-between rounded-md border border-black p-5 dark:border-white">
        ...
        <div>
          <img
            className="min-h-[60px] object-cover text-center"
      ...
      <div className="mt-2 flex w-full items-center justify-between rounded-md border border-black p-5 dark:border-white">
        <div>
          <h2 className="text-xl text-black dark:text-white">
        ...
        <div>
          <img
            className="min-h-[60px] object-cover"
...
const TrendingCoins = ({ data, setCoinModalStatus }) => {
  ...
  return (
    <div className="w-[63%] rounded-md border border-black p-5 pb-0 dark:border-white">
